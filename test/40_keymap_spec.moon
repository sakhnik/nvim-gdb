...
expose "#keymap", ->
    ...
    it 'conflict', ->
        ...
        count = eng\eval 'luaeval("(function() local c = 0; for _,_ in pairs(gdb.getConfig():get()) do c = c + 1 end return c end)()")'
    ...
    it 'override', ->
        ...
        launch!
        key = eng\eval 'luaeval("gdb.getConfig():get().key_next")'
    ...
    it 'override priority', ->
        ...
        launch!
        res = eng\eval 'luaeval("gdb.getConfig():get().key_breakpoint == nil")'
    ...
    it 'overall', ->
        ...
        launch!
        res = eng\eval 'luaeval("gdb.getConfig():get().key_continue == nil")'
        assert.are.same true, res
        res = eng\eval 'luaeval("gdb.getConfig():get().key_next == nil")'
        assert.are.same true, res
        key = eng\eval 'luaeval("gdb.getConfig():get().key_step")'
