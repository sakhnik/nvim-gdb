    ...
    describe 'detect', ->
        ...
        for backend, spec in pairs(backends)
            it '#'..backend, ->
                ...
                assert.are.same {'cur': 'test.cpp:17', 'break': {[1]: {17}}}, eng\getSigns!
    ...
    describe 'navigate', ->
        ...
        for backend, spec in pairs(backends)
            it '#'..backend, ->
                ...
                assert.are.same {'break': {[1]: {5, 10}}}, eng\getSigns!
                ...
                eng\feed ":8\n"
                eng\feed "<f8>"
                assert.are.same {'break': {[1]: {8}}}, eng\getSigns!
    ...
    describe 'clear all', ->
        ...
        for backend, spec in pairs(backends)
            it '#'..backend, ->
                ...
                assert.are.same {'break': {[1]: {5,10,17}}}, eng\getSigns!
    ...
    describe 'duplicate', ->
        ...
        for backend, spec in pairs(backends)
            it '#'..backend, ->
                ...
                assert.are.same {'cur': 'test.cpp:17', 'break': {[1]: {17}}}, eng\getSigns!
                eng\feed spec.break_main
                assert.are.same {'cur': 'test.cpp:17', 'break': {[2]: {17}}}, eng\getSigns!
                eng\feed spec.break_main
                assert.are.same {'cur': 'test.cpp:17', 'break': {[3]: {17}}}, eng\getSigns!
