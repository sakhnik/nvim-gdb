...
function! s:DefineCommands()
  ...
  command! GdbUntil call GdbSend('until %s', line('.'))
  ...
  command! GdbEvalWord call GdbSend('print %s', expand('<cword>'))
  command! -range GdbEvalRange call GdbSend('print %s', s:GetExpression(<f-args>))
endfunction
